document.addEventListener('DOMContentLoaded', () => {
                ...
                <body>
                    <div style="text-align: center; margin-bottom: 20px;">
                        <button id="real-print-btn" onclick="window.print()" style="padding: 12px 24px; font-size: 1.1rem; cursor: pointer; background: #8b5cf6; color: white; border: none; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                            🖨️ ${window.i18n.t("print_save_pdf", "Print / Save as PDF")}
                        </button>
                    </div>
    ...
    function saveProfile(data) {
        ...
        btnSave.textContent = window.i18n.t("saved", "Saved ✓");
    ...
    function getInterpretation(data) {
        ...
        if (data.periodStart && data.periodEnd) {
            ...
            periodText = `<p style="color: #fcd34d; font-size: 0.95rem; margin-top: 10px; font-weight: bold;">🎯 ${window.i18n.t("focus_period", "Focus Period")}: ${startStr} ${window.i18n.t("to", "to")} ${endStr}</p>`;
        }
